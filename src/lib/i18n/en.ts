...
export const en: Record<MsgKey, string> = {
  ...
  "history.verified": "Verified by server",
  ...
  "friends.search_name": "Search name",
  "friends.name_invalid": "Enter at least 2 characters of the in-game name.",
  "friends.name_search_hint": "In-game names use the server's official search so you can choose the right player when names match. A SteamID64 is still sent directly.",
  "friends.name_search_opened": "The server's official name search is open. Choose the right player and press Add.",
  "friends.name_search_error": "The current server page could not be identified. Try again while your dino is online.",
  ...
  "voice.title": "Server Voice",
  "voice.subtitle": "Voice must run through the official hub or client of the server you are playing on.",
  ...
  "voice.ready_hint": "The official DinoVietnam hub is signed in. Open it to join the Voice room authorized by that server.",
  "voice.login_hint": "Voice requires the server's own hub. Open DinoVietnam and sign in with Steam there once, then refresh this status.",
  "voice.install_hint": "Install the official hub supplied by your server to use its Voice system. DinoVietnam is detected automatically on this PC.",
  ...
  "voice.security_note": "The server's official hub handles Voice, microphone, push-to-talk, Steam authentication, and room access. islemap-thienvyma only detects and opens it; it does not replace the server hub.",
  ...
  "skin.saved_title": "SAVED SKINS",
  "skin.saved_hint": "Save this palette under a name and load it again later on the same provider.",
  "skin.saved_name": "Skin name",
  "skin.save": "Save skin",
  "skin.saved": "The skin was saved on this PC.",
  "skin.loaded": "Loaded {name}.",
  "skin.saved_empty": "No saved skins for this provider yet.",
  "skin.save_invalid": "Enter a name and a valid color palette before saving.",
  "skin.saved_incompatible": "This saved skin uses a different set of color zones for the current server.",
  "skin.delete_named": "Delete saved skin {name}",
