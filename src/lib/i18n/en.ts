...
export const en: Record<MsgKey, string> = {
  ...
  "voice.subtitle": "Connects to the Voice service authorized by the server you are currently playing on.",
  "voice.checking": "Checking Voice support…",
  "voice.server": "CURRENT SERVER",
  "voice.not_connected": "No server connected",
  "voice.provider": "VOICE PROVIDER",
  "voice.provider_none": "Not configured",
  "voice.status": "STATUS",
  "voice.state_not_configured": "Not configured",
  "voice.state_login_required": "Sign-in required",
  "voice.state_authorizing": "Waiting for sign-in",
  "voice.state_ready": "Ready",
  "voice.state_unavailable": "Temporarily unavailable",
  "voice.state_blocked": "Server support required",
  "voice.state_error": "Connection error",
  "voice.not_configured_hint": "This server has not configured a compatible Voice adapter for the hub.",
  "voice.login_hint": "Sign in through the server's normal browser flow to authorize Voice for your own account.",
  "voice.authorizing_hint": "Complete the sign-in in your browser. The hub will update automatically after the callback.",
  "voice.ready_hint": "Your server session is ready to request a short-lived Voice room grant.",
  "voice.unavailable_hint": "The configured Voice service cannot be reached right now. Your valid session is kept for retrying.",
  "voice.blocked_hint": "This server must expose a public player login and short-lived Voice token broker before the hub can connect.",
  "voice.error_hint": "The Voice adapter rejected invalid or unexpected data. Refresh after checking the current server connection.",
  "voice.server_owner_hint": "Server owners can add support by providing a documented player login callback and short-lived Voice grant endpoint.",
  "voice.identity": "SIGNED-IN PLAYER",
  "voice.identity_unknown": "Authenticated player",
  "voice.steam_id": "SteamID64",
  "voice.sign_in": "Sign in for Voice",
  "voice.logout": "Sign out",
  "voice.refresh": "Refresh",
  "voice.status_error": "Could not read the Voice provider status.",
  "voice.action_error": "The Voice provider could not complete this action.",
  ...
  "garage.self_slay": "Self-slay dino",
  "garage.self_slay_disabled": "This server has disabled self-slay.",
  "garage.self_slay_offline": "Join the server with an active dino, then refresh the Garage.",
  "garage.confirm_self_slay":
    "Self-slay the dino you are playing? The current dino will die and this cannot be undone.",
  "garage.park_cancel": "Cancel",
  "garage.park_cancelled": "Parking cancelled.",
  "garage.park_wait": "Parking in {seconds}s — stand still and do not take damage.",
  "garage.park_finalizing": "Confirming the park request…",
  "garage.park_polling": "Waiting for the server to finish parking…",
  "garage.restore": "Restore",
  "garage.sell": "Delete / sell",
  ...
  "garage.confirm_sell":
    "Delete/sell “{name}” from the Garage? The server may award currency and this cannot be undone.",
  "garage.delete_disabled":
    "This server currently disables deleting/selling parked dinos; the hub will enable the button when the server allows it.",
  ...
  "skin.preset_green_black": "Deep green · black veins",
  "skin.preset_black": "Black",
  "skin.preset_white": "White",
  "skin.preset_forest": "Forest",
  "skin.preset_desert": "Desert",
  "skin.preset_shadow": "Shadow",
  "skin.preset_snow": "Snow",
  "skin.preset_ocean": "Ocean",
  "skin.preset_ember": "Ember",
  "skin.preset_loaded": "Loaded the {name} palette.",
  "skin.random": "Random",
  "skin.randomized": "Generated a new random palette.",
