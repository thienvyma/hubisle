...
export const en: Record<MsgKey, string> = {
  ...
  "tab.friends": "Friends",
  "tab.voice": "Voice",
  "tab.viethoa": "Vietnamese",

  "history.title": "Combat history",
  "history.subtitle":
    "Shows the display name and species of players who attacked you when the current server supplies identity data.",
  ...
  "history.empty_hint": "Keep the hub running and the server connected. Entries appear only when the server supplies the opponent name or species.",
  ...
  "history.player_name": "Player display name",
  "history.attacker_species": "Attacker species",
  ...
  "friends.manage_hint": "Add by SteamID64, accept or decline requests, and manage location sharing from the hub.",
  ...
  "friends.unknown_player": "Unknown player",

  "voice.title": "DinoVietnam Voice",
  "voice.subtitle": "Open DinoVietnam's original voice system from the hub and check the Steam sign-in status on this PC.",
  "voice.checking": "Checking DinoVietnam Voice…",
  "voice.client": "OFFICIAL CLIENT",
  "voice.ready": "Installed",
  "voice.missing": "Not installed",
  "voice.authenticated": "Signed in",
  "voice.login_needed": "Sign-in required",
  "voice.process": "STATUS",
  "voice.running": "Running",
  "voice.stopped": "Not running",
  "voice.ready_hint": "The official client's Steam session is ready. Open Voice so the client joins the room authorized by the DinoVietnam server.",
  "voice.login_hint": "Open the DinoVietnam client and sign in with Steam once. Then return here and refresh the status.",
  "voice.install_hint": "Install the official DinoVietnam client to use Voice. The hub will detect it automatically afterwards.",
  "voice.open_voice": "Open DinoVietnam Voice",
  "voice.open_login": "Open Steam sign-in",
  "voice.launching": "Opening…",
  "voice.download": "Download official client",
  "voice.security_note": "Voice, microphone, push-to-talk, and room access remain handled by the official client. The hub only checks status and opens it; it never reads or copies the encrypted Voice token.",
  "voice.refresh": "Refresh",
  "voice.official_source": "Official source",
  "voice.status_error": "Could not check DinoVietnam Voice status.",
  "voice.launch_error": "Could not open the DinoVietnam Voice client.",
  "voice.link_error": "Could not open the DinoVietnam release page.",

  "viethoa.title": "The Isle Vietnamese translation",
  "viethoa.subtitle": "Open the official Vietnamese translation installer already installed by DinoVietnam on this computer.",
  "viethoa.checking": "Checking the translation package…",
  "viethoa.ready": "The official installer is ready",
  "viethoa.version": "Version",
  "viethoa.launch": "Open installer",
  "viethoa.launching": "Opening…",
  "viethoa.close_game": "Exit The Isle before running the installer so game files are not locked.",
  "viethoa.not_installed": "The official installer was not found",
  "viethoa.official_required": "The encrypted package belongs to DinoVietnam. Install it once from the official source; you can then launch it directly from here.",
  "viethoa.open_official": "Open official release",
  "viethoa.refresh": "Check again",
  "viethoa.source": "Package source",
  "viethoa.status_error": "Could not check the Vietnamese translation installer.",
  "viethoa.launch_error": "Could not start the official Vietnamese translation installer.",
  "viethoa.link_error": "Could not open the official release page.",
