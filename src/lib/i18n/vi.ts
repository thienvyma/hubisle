...
export const vi = {
  ...
  "voice.subtitle": "Tính năng thoại bắt buộc chạy qua hub hoặc client chính thức của server bạn đang chơi.",
  "voice.checking": "Đang kiểm tra Voice DinoVietnam…",
  "voice.client": "CLIENT CHÍNH THỨC",
  "voice.ready": "Đã cài đặt",
  "voice.missing": "Chưa cài đặt",
  "voice.authenticated": "Đã đăng nhập",
  "voice.login_needed": "Cần đăng nhập",
  "voice.process": "TRẠNG THÁI",
  "voice.running": "Đang chạy",
  "voice.stopped": "Chưa chạy",
  "voice.ready_hint": "Hub DinoVietnam chính thức đã đăng nhập. Hãy mở hub đó để tham gia phòng thoại do server cấp.",
  "voice.login_hint": "Thoại cần hub riêng của server. Hãy mở DinoVietnam và đăng nhập Steam tại đó một lần, rồi kiểm tra lại trạng thái.",
  "voice.install_hint": "Cài hub chính thức do server cung cấp để dùng hệ thống thoại của server. DinoVietnam sẽ được tự động nhận diện trên máy này.",
  "voice.open_voice": "Mở Voice DinoVietnam",
  "voice.open_login": "Mở đăng nhập Steam",
  "voice.launching": "Đang mở…",
  "voice.download": "Tải client chính thức",
  "voice.security_note": "Hub chính thức của server xử lý thoại, micro, phím nhấn để nói, đăng nhập Steam và quyền vào phòng. islemap-thienvyma chỉ nhận diện và mở hub đó, không thay thế hub của server.",
  "voice.refresh": "Kiểm tra lại",
  "voice.official_source": "Nguồn chính thức",
  "voice.status_error": "Không thể kiểm tra trạng thái Voice DinoVietnam.",
  "voice.launch_error": "Không thể mở client Voice DinoVietnam.",
  "voice.link_error": "Không thể mở trang phát hành DinoVietnam.",
