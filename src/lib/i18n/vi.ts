...
export const vi = {
  ...
  "history.subtitle":
    "Hiển thị tên và loài của người chơi đã tấn công bạn khi server hiện tại cung cấp dữ liệu danh tính.",
  ...
  "history.empty_hint": "Giữ hub chạy và kết nối server trong lúc chơi. Lịch sử chỉ hiện khi server gửi tên hoặc loài của đối phương.",
  ...
  "friends.search_name": "Tìm theo tên",
  "friends.name_invalid": "Nhập ít nhất 2 ký tự của tên trong game.",
  "friends.name_search_hint": "Tên trong game được tìm trên trang chính thức của server để bạn chọn đúng người khi có tên trùng. SteamID64 vẫn được gửi trực tiếp.",
  "friends.name_search_opened": "Đã mở tìm kiếm tên chính thức của server. Chọn đúng người rồi bấm Add.",
  "friends.name_search_error": "Chưa xác định được trang server hiện tại để tìm tên. Hãy thử lại khi nhân vật đang online.",
  ...
  "friends.incoming": "Lời mời đến",
  "friends.outgoing": "Đang chờ chấp nhận",
  "friends.accept": "Chấp nhận",
  "friends.decline": "Từ chối",
  "friends.remove": "Xóa bạn",
  "friends.cancel": "Hủy lời mời",
  "friends.unknown_player": "Người chơi chưa rõ",

  "voice.title": "Thoại của server",
  "voice.subtitle": "Kết nối dịch vụ thoại được server bạn đang chơi cho phép.",
  "voice.checking": "Đang kiểm tra hỗ trợ thoại…",
  "voice.server": "SERVER HIỆN TẠI",
  "voice.not_connected": "Chưa kết nối server",
  "voice.provider": "NHÀ CUNG CẤP THOẠI",
  "voice.provider_none": "Chưa cấu hình",
  "voice.status": "TRẠNG THÁI",
  "voice.state_not_configured": "Chưa cấu hình",
  "voice.state_login_required": "Cần đăng nhập",
  "voice.state_authorizing": "Đang chờ đăng nhập",
  "voice.state_ready": "Sẵn sàng",
  "voice.state_unavailable": "Tạm thời không khả dụng",
  "voice.state_blocked": "Cần server hỗ trợ",
  "voice.state_error": "Lỗi kết nối",
  "voice.not_configured_hint": "Server này chưa cấu hình adapter thoại tương thích với hub.",
  "voice.login_hint": "Đăng nhập bằng quy trình trình duyệt bình thường của server để cấp quyền thoại cho tài khoản của bạn.",
  "voice.authorizing_hint": "Hoàn tất đăng nhập trong trình duyệt. Hub sẽ tự cập nhật sau khi nhận callback.",
  "voice.ready_hint": "Phiên server đã sẵn sàng để yêu cầu quyền vào phòng thoại có thời hạn ngắn.",
  "voice.unavailable_hint": "Hiện không thể kết nối dịch vụ thoại đã cấu hình. Phiên hợp lệ vẫn được giữ để thử lại.",
  "voice.blocked_hint": "Server cần cung cấp đăng nhập người chơi công khai và bộ cấp token thoại ngắn hạn để hub có thể kết nối.",
  "voice.error_hint": "Adapter thoại nhận được dữ liệu không hợp lệ. Hãy kiểm tra kết nối server hiện tại rồi làm mới.",
  "voice.server_owner_hint": "Chủ server có thể bổ sung hỗ trợ bằng callback đăng nhập người chơi và endpoint cấp quyền thoại ngắn hạn có tài liệu.",
  "voice.identity": "NGƯỜI CHƠI ĐÃ ĐĂNG NHẬP",
  "voice.identity_unknown": "Người chơi đã xác thực",
  "voice.steam_id": "SteamID64",
  "voice.sign_in": "Đăng nhập thoại",
  "voice.logout": "Đăng xuất",
  "voice.refresh": "Kiểm tra lại",
  "voice.status_error": "Không thể đọc trạng thái nhà cung cấp thoại.",
  "voice.action_error": "Nhà cung cấp thoại không thể hoàn thành thao tác này.",
  ...
  "garage.self_slay": "Tự sát Dino",
  "garage.self_slay_disabled": "Server này đang tắt tính năng tự sát Dino.",
  "garage.self_slay_offline": "Hãy vào hẳn server với một Dino đang hoạt động rồi làm mới Garage.",
  "garage.confirm_self_slay":
    "Tự sát Dino đang chơi? Dino hiện tại sẽ chết và thao tác này không thể hoàn tác.",
  "garage.park_cancel": "Hủy",
  "garage.park_cancelled": "Đã hủy cất Dino.",
  "garage.park_wait": "Cất sau {seconds} giây — hãy đứng yên và không nhận sát thương.",
  "garage.park_finalizing": "Đang xác nhận lệnh cất…",
  "garage.park_polling": "Đang chờ server hoàn tất lệnh cất…",
  ...
  "garage.confirm_sell":
    "Xóa/bán dino “{name}” khỏi Garage? Server có thể trả thưởng và thao tác này không thể hoàn tác.",
  "garage.delete_disabled":
    "Server hiện đang tắt quyền xóa/bán Dino đã cất; hub sẽ tự bật nút khi server cho phép.",
  ...
  "skin.saved_title": "SKIN ĐÃ LƯU",
  "skin.saved_hint": "Đặt tên cho bảng màu này để dùng lại sau trên cùng provider.",
  "skin.saved_name": "Tên skin",
  "skin.save": "Lưu skin",
  "skin.saved": "Đã lưu skin trên máy này.",
  "skin.loaded": "Đã nạp {name}.",
  "skin.saved_empty": "Chưa có skin đã lưu cho provider này.",
  "skin.save_invalid": "Hãy nhập tên và chọn bảng màu hợp lệ trước khi lưu.",
  "skin.saved_incompatible": "Skin đã lưu dùng bộ vùng màu khác với server hiện tại.",
  "skin.delete_named": "Xóa skin đã lưu {name}",
  "skin.presets": "PHỐI MÀU NHANH",
  "skin.preset_green_black": "Xanh đậm · gân đen",
  "skin.preset_black": "Đen",
  "skin.preset_white": "Trắng",
  "skin.preset_forest": "Rừng",
  "skin.preset_desert": "Sa mạc",
  "skin.preset_shadow": "Bóng tối",
  "skin.preset_snow": "Tuyết",
  "skin.preset_ocean": "Đại dương",
  "skin.preset_ember": "Dung nham",
  "skin.preset_loaded": "Đã nạp phối màu {name}.",
  "skin.random": "Ngẫu nhiên",
  "skin.randomized": "Đã tạo một phối màu ngẫu nhiên mới.",
