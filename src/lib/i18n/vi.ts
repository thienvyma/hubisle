...
export const vi = {
  ...
  "voice.title": "Voice DinoVietnam",
  "voice.subtitle": "Mở hệ thống thoại gốc của DinoVietnam ngay từ hub và kiểm tra trạng thái đăng nhập Steam trên máy.",
  ...
  "voice.ready_hint": "Phiên Steam của client chính thức đã sẵn sàng. Mở Voice để client tham gia đúng phòng thoại do server DinoVietnam cấp.",
  "voice.login_hint": "Mở client DinoVietnam và đăng nhập Steam một lần. Sau đó quay lại đây và bấm Kiểm tra lại.",
  "voice.install_hint": "Cài client DinoVietnam chính thức để dùng Voice. Hub sẽ tự nhận diện sau khi cài.",
  ...
  "voice.security_note": "Voice, micro, phím nhấn để nói và quyền vào phòng vẫn do client chính thức xử lý. Hub chỉ kiểm tra trạng thái và mở client; hub không đọc hoặc sao chép token Voice đã mã hóa.",
  ...
  "viethoa.title": "Việt hóa The Isle",
  "viethoa.subtitle": "Mở trình cài Việt hóa chính thức đã được DinoVietnam cài trên máy này.",
  "viethoa.checking": "Đang kiểm tra gói Việt hóa…",
  "viethoa.ready": "Trình cài chính thức đã sẵn sàng",
  "viethoa.version": "Phiên bản",
  "viethoa.launch": "Mở trình cài",
  "viethoa.launching": "Đang mở…",
  "viethoa.close_game": "Hãy thoát The Isle trước khi chạy trình cài để tránh file game đang bị khóa.",
  "viethoa.not_installed": "Chưa tìm thấy trình cài chính thức",
  "viethoa.official_required": "Gói phát hành được mã hóa và thuộc DinoVietnam. Cần cài gói một lần từ nguồn chính thức; sau đó bạn có thể mở và dùng trực tiếp tại đây.",
  "viethoa.open_official": "Mở bản phát hành chính thức",
  "viethoa.refresh": "Kiểm tra lại",
  "viethoa.source": "Nguồn gói",
  "viethoa.status_error": "Không thể kiểm tra trình cài Việt hóa.",
  "viethoa.launch_error": "Không thể mở trình cài Việt hóa chính thức.",
  "viethoa.link_error": "Không thể mở trang phát hành chính thức.",
